...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.title("Blue Grabber [Builder]")
        ...
        self.logo_image = customtkinter.CTkImage(Image.open(os.path.join(image_path, "blue.png")), size=(60, 60))
        self.large_test_image = customtkinter.CTkImage(Image.open(os.path.join(image_path, "blue.png")), size=(500, 150))
        self.image_icon_image = customtkinter.CTkImage(Image.open(os.path.join(image_path, "blue.png")), size=(20, 20))
        ...
        self.font = "Supernova"
        self.iconpath = None
        self.iconbitmap(f"{image_path}blue.ico")

        self.navigation_frame = customtkinter.CTkFrame(self, corner_radius=0)
        self.navigation_frame.grid(row=0, column=0, sticky="nsew")
        self.navigation_frame.grid_rowconfigure(4, weight=1)

        self.navigation_frame_label = customtkinter.CTkLabel(self.navigation_frame, text="  Blue Grabber", image=self.logo_image,
        ...
        self.webhook_button = customtkinter.CTkEntry(self.builder_frame, width=570, height=35, font=customtkinter.CTkFont(
            size=15, family=self.font), placeholder_text="Enter Webhook Here")
    ...
    def get_config(self):
        with open(self.basefilepath + "\\blue.py", 'r', encoding="utf-8") as f:
            code = f.read()
        ...
        if config_match:
            ...
            raise Exception("Could not find config in blue.py")
